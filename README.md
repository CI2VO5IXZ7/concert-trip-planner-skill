...
> "我在泰州，想去看郑州的演唱会，次日9点半前回到泰州九龙镇"

Agent 会：
1. WebSearch 验证演唱会场地和历史时长
2. FlyAI 搜索泰州→郑州去程高铁
3. 高德 REST API 查询郑州东站→场馆的地铁路线（实测时间）
4. **反向规划返程**（凌晨段 + 早班段双次搜索）：
   - 郑州→泰州无夜间高铁，最早高铁到达超出截止时间
   - 尝试多段联运：郑州→徐州（凌晨动车）→打车至徐州东→扬州东→自驾回九龙镇
5. 找到可行链条：08:45 到达，满足 09:30 截止
6. 输出完整分钟级行程单，风险评估 MEDIUM
